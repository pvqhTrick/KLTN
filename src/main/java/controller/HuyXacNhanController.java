...
/**
 * Servlet implementation class HuyXacNhanController
 */
@WebServlet("/HuyXacNhan")
public class HuyXacNhanController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public HuyXacNhanController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			bbo.HuyXacNhan(Integer.parseInt(IdDatPhong));
