					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="p-5">
								...
								if (error=="unknow") {
								%>
								<div class="alert alert-danger">Thông tin không chính xác</div>

								<%
								}
								%>	
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-4">Đăng nhập Hệ quản trị CSDL ADMIN</h1>
								</div>
								<form class="user" action="ADMIN" method="post">
									<div class="form-group mb-2">
										<input type="text" class="form-control form-control-user"
											id="userName" name="txtun" placeholder="Tài khoản">
									</div>
									<div class="form-group mb-2">
									...
									<input type="submit"
										class="btn btn-primary btn-user btn-block mb-2"
