...
<body>
	<%
	ArrayList<NhanVien> dsNV = (ArrayList<NhanVien>) session.getAttribute("dsNV");
	%>
               ...
               with font-awesome or any other icon font library -->
					<li class="nav-item  menu-open"><a href="#"
						...
						<ul class="nav nav-treeview">
							...
							<li class="nav-item"><a href="AdminQLNV" class="nav-link  active">
									<i class="far fa-circle nav-icon"></i>
									<p>Quản lý Nhân viên</p>
							</a></li>
						</ul></li>

					<li class="nav-item"><a href="AdminXacNhan" class="nav-link active">
							<i class="nav-icon fas fa-copy"></i>
							<p>
								Xác nhận đặt phòng <span class="badge badge-info right"><%=dsDatPhong.size() %></span>
							</p>
					</a></li>
					<li class="nav-item"><a href="AdminThongKe" class="nav-link"> <i
						...
						<div class="card">
							...
							<div class="card-body">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<tr>
											<th scope="row"><%=item.getIdNhanVien()%></th>
											<td><%=item.getHoTen()%></td>
											...
											<td><a href="UserProfile?Id=<%=item.getIdNhanVien()%>"><button
														type="button" class="btn btn-primary">
														<i class="fa fa-info"></i> Detail
													</button></a></td>
											<td><a href="XoaKhachHang?Id=<%=item.getIdNhanVien()%>"><button
														type="button" class="btn btn-primary">
