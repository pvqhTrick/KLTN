...
<header>
	...
	<div class="bg-primary mb-4">
		<div class="container py-4">
			<h3 class="text-white mt-2">Thông tin cá nhân</h3>
			<!-- Breadcrumb -->
			<nav class="d-flex mb-2">
				<h6 class="mb-0">
					<a href="Rooms" class="text-white-50">Home</a> <span
						class="text-white-50 mx-2"> > </span> <a
						href="UserProfile" class="text-white-50">User</a> <span
						class="text-white-50 mx-2"> > </span> <a
						href="UserProfile" class="text-white-50">User
						Profile</a>
				</h6>
			</nav>
			<!-- Breadcrumb -->
...
<body>
	...
	<section style="background-color: #eee;">
		<div class="row">
			...
			<div class="col-lg-8">
				<form action="SuaKhachHang?IdSua=<%=user.getIdKhachHang() %>" method="post">
					<div class="card mb-4">
						<div class="card-body">
							<div class="row">
								<div class="col-sm-3">
							...
							<div class="row">
								...
								<div class="col-sm-9">
									<p class="text-muted mb-0"><%=user.getSDT()%></p>
								</div>
							</div>
							<hr>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-9">
									<p class="text-muted mb-0"><%=user.getCCCD()%></p>
								</div>
							</div>
							<hr>
							<div class="row">
